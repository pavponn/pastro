...
class ConfigurationLatticeTest {
    ...
    fun `should correctly compare comparable (non equal) configurations with leq`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2, TRANSACTION_3))
        Assert.assertTrue(configurationOne leq configurationTwo)
    }

    @Test
    fun `should correctly compare equal configurations with leq`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2, TRANSACTION_3))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2, TRANSACTION_3))
        Assert.assertTrue(configurationOne leq configurationTwo)
    ...
    fun `should correctly compare equal configurations with eq`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_3))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_3))
    ...
    fun `should correctly compare non equal configurations with eq`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_3))
    ...
    fun `should correctly compare equal configurations with noteq`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2))
    ...
    fun `should merge two incomparable configurations correctly`() {
        val configurationOne = ConfigurationImpl(setOf(TRANSACTION_1, TRANSACTION_2))
        val configurationTwo = ConfigurationImpl(setOf(TRANSACTION_3, TRANSACTION_4))
        val mergeConfiguration = configurationOne merge configurationTwo
        Assert.assertTrue(
            mergeConfiguration
                .getTransactions()
